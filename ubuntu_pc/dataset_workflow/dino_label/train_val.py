...
image_files = [f for f in os.listdir(images_dir) if f.endswith('.png')] + [f for f in os.listdir(images_dir) if f.endswith('.jpg')]

random.shuffle(image_files)

train_size = int(0.85 * len(image_files))  # 80% 作为训练集
